...
### List (with comments) of the 49 *.apk* to uninstall (.apk that contain trackers and can be replaced by better apps) and other useful commands. Note that this is the bloatware I found on my phone but the list depends on the device and manufacturer.
